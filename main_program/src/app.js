...
const I18N = {
  zh: {
    ...
    brandTipMini: "点击活细胞进入模块，滚轮缩放/拖拽平移，单格放大到超过屏幕后自动下潜。方向键：←→ 调节节奏，↑↓ 缩放画布。",
    toolbarAria: "首页控件",
    speedLabel: "演化节奏",
  ...
  en: {
    ...
    brandTipMini: "Click live cells to open modules. Wheel to zoom, drag to pan, and dive deeper when one cell exceeds the viewport. Arrow keys: Left/Right adjust pace, Up/Down adjust zoom.",
